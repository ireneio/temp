...
import getImage, { dashboardCost } from '@meepshop/images';

const Example = React.memo(() =>
  <img src={getImage(dashboardCost)} />
);`,
...
import getImage, { dashboardCost_w30_h30 as dashboardCost } from '@meepshop/images';
