...
import MemberOrderApplyList from '@meepshop/meep-ui/lib/memberOrderApplyList'; // eslint-disable-line import/no-unresolved
import { Router } from 'server/routes';
import * as Actions from 'ducks/actions';
import * as TITLE from 'locales';

class MemberOrderApllyList extends Component {
...
const mapStateToProps = (state, props) => {
  ...
  return {
    ...
    title: TITLE.ORDER_APPLY_LIST[locale],
...
export default connect(mapStateToProps)(MemberOrderApllyList);
