...
export default class FacebookWall extends React.PureComponent {
  ...
  componentDidMount() {
    if (window.FB && window.meepShopStore.fbSdkIsInstalled) {
       ...
       *
       * The DOM will be parsed by FB api when the page is responsed.
       * After the client side render, react will override DOM and
       * the DOM which is generated by FB api will disappear.
       */
