...
export default React.memo(({ store }: PropsType) => {
  ...
  return (
    <>
      ...
      <div className={styles.notEditableValue}>{store?.cname}</div>
      ...
      <FormItem name={['description', 'introduction']}>
        <TextArea
